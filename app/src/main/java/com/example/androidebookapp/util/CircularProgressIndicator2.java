...
public class CircularProgressIndicator2 extends View {
    ...
    private static final String DEFAULT_PROGRESS_COLOR = GlobalVariables.AUD_PROGRESS_COLOR;
    private static final int DEFAULT_TEXT_SIZE_SP = GlobalVariables.RESULT_PROGRESS_TEXT_SIZE;
    private static final int DEFAULT_STROKE_WIDTH_DP = GlobalVariables.RESULT_PROGRESS_STROKE_WIDTH;
    private static final String DEFAULT_PROGRESS_BACKGROUND_COLOR = GlobalVariables.AUD_PROGRESS_BG_COLOR;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircularProgressIndicator2);

            progressColor = a.getColor(R.styleable.CircularProgressIndicator2_progressColor, progressColor);
            progressBackgroundColor = a.getColor(R.styleable.CircularProgressIndicator2_progressBackgroundColor, progressBackgroundColor);
            progressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator2_progressStrokeWidth, progressStrokeWidth);
            textColor = a.getColor(R.styleable.CircularProgressIndicator2_textColor, progressColor);
            textSize = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator2_textSize, textSize);

            shouldDrawDot = a.getBoolean(R.styleable.CircularProgressIndicator2_drawDot, shouldDrawDot);
            dotColor = a.getColor(R.styleable.CircularProgressIndicator2_dotColor, progressColor);
            dotWidth = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator2_dotWidth, progressStrokeWidth);

            startAngle = a.getInt(R.styleable.CircularProgressIndicator2_startAngle, DEFAULT_PROGRESS_START_ANGLE);
    ...
    public void SetAttributes(int progressColor, int dotColor, int progressBackgroundColor, int textColor, int textSize) {
        ...
        setProgressStrokeWidthDp(GlobalVariables.AUD_PROGRESS_STROKE_WIDTH);
        setDotWidthDp(GlobalVariables.AUD_PROGRESS_STROKE_WIDTH);
    }
