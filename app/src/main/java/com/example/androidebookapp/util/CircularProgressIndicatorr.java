...
public class CircularProgressIndicatorr extends View {
    ...
    public CircularProgressIndicatorr(Context context) {
        super(context);
        init(context, null);
    }

    public CircularProgressIndicatorr(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CircularProgressIndicatorr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CircularProgressIndicatorr(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
