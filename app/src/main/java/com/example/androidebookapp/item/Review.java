...
public class Review {
    ...
    public Review(String queId, String question, String imgUrl, String rightAns, String wrongAns, ArrayList<String> optionList, String extraNote) {
        this.queId = queId;
    ...
    public int getQueId() {
        return Integer.parseInt(String.valueOf(queId));
    }
